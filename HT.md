...
BASICALLY
BIOS DEFAULT : ON = MORE FRAMES BUT POOR LATENCY. SAFE TO DISABLE IN 8 CORE SYSTEM, TEST ON 6 CORES. * PERSONAL EXPERIENCE; IN MY INTEL & RYZEN OF 6 CORES I HAVE IT OFF.
OFF: LOWEST LATENCY, MOUSE WILL FEEL AMAZING, BUT CAREFUL WITH HIGH POLLING RATES IN 6 CORES SYSTEM, THIS WILL USE MORE CPU. 
